...
- Fixed an issue where the `program` node didn't always start at `(0, 0)` (#132).
- To align better with the R grammar and to greatly simplify the possible states in the tree-sitter grammar, some fields are no longer optional (#126).
